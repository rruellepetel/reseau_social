...
from .views import ProfileDetailView,ProfileListView,ProfileUpdate,ProfileMapView,ProfileListJsonView

urlpatterns = [
    url(r'^list$', ProfileListView.as_view(), name="profile-list"),
    url(r'^map$', ProfileMapView.as_view(), name="profile-map"),
    url(r'^list/json$', ProfileListJsonView.as_view(), name="profile-json"),
